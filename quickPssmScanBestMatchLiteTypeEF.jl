"""usage: julia quickPssmScanBestMatchLiteTypeEF.jl memefile file.faa tagname resuldir basecompositionfile"""
...
"""This function takes in a memefile, a set of sequences, and output the best score for each sequence by each motif in each separate file"""
    ...
    sequencefile = ARGS[2]
    tag = ARGS[3]
    resultdir = ARGS[4] #add this tag to all of the result files(at the end)
    bgfile =ARGS[5]
    ...
    global transdict=Dict('A'=>'T','C'=>'G','G'=>'C','T'=>'A', 'N'=>'N','E'=>'F','F'=>'E')
